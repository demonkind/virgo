...
/**
 * Created by jianfei.chen on 2015/3/19.
 */
public class UrlValid extends UrlValidator {
     ...
     */
    public UrlValid(String[] schemes) {
        this(schemes, 0L);
    }
     ...
     *                ALLOW_2_SLASHES + NO_FRAGMENTS enables both of those options.
     */
    public UrlValid(String[] schemes, long options) {
     ...
     */
    public UrlValid(RegexValidator authorityValidator, long options) {
     ...
     *                           enables both of those options.
     */
    public UrlValid(String[] schemes, RegexValidator authorityValidator, long options) {
